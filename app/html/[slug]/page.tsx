...
export default async function HtmlTopicPage({ params }: Props) {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      <div className="max-w-5xl mx-auto px-6 py-12 space-y-12">
        ...
        {/* Hero */}
        <div className="relative bg-gradient-to-br from-indigo-600 via-blue-500 to-purple-600 text-white rounded-3xl p-10 shadow-lg overflow-hidden">

          <div className="absolute -top-6 -right-6 text-white/10 text-[120px] font-bold pointer-events-none">
            &lt;{slug}&gt;
          </div>

          <span className="inline-block bg-white/20 px-4 py-1 rounded-full mb-6">
            HTML
          </span>
        ...
        <div className="bg-white rounded-2xl p-8 shadow-sm border">
          ...
          {topic.exampleCode && (
            <pre className="bg-black text-green-400 p-6 mt-6 rounded-xl overflow-x-auto text-sm">
              {topic.exampleCode}
            </pre>
          )}
        </div>
